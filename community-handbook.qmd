...
Work is in progress (as of September 2024) to close the WordPress site and move to a Quarto site published through GitHub and with event registration being supported from an external system.

:::

_The following information will be archived_
...
For NHS-R Community it's possible to sign up with a personal email and notify the [the core development team](#contact-us) about having your account set to Core Member.

## Membership access to courses
