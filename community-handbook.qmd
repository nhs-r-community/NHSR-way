...
The site automatically detects emails according to a white list that is maintained through the website and so we can add to that when notified at [nhs.rcommunity@nhs.net](mailto:nhs.rcommunity@nhs.net).
...
It is possible to request a password reset, however, if this is going to an address that has changed due to organisational change or you have moved job, please contact [nhs.rcommunity@nhs.net](mailto:nhs.rcommunity@nhs.net) for this to be updated manually.
