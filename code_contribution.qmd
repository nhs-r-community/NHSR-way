# Contributing to our codebase {#code-contribution .unnumbered}
👩‍💻👨‍💻 
...
If you spot any errors, have any suggested changes or additions you'd like to make to anny of our code-based resources, you can [submit a Pull Request (PR)](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request). Please ensure you follow our [Code of Conduct](#code-of-conduct)while doing so. If your PR concerns a bug you've found, you'll get a better response if you include a **rep**roducible **ex**ample and there is a package that can help called [{reprex}](https://reprex.tidyverse.org/). Here's a [video](https://www.youtube.com/watch?v=iLfzNWh2dLI) on how to do this!
