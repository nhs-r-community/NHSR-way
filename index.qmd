...
Welcome to the NHS-R Community Way book for the [NHS-R Community](https://nhsrcommunity.com/) based on [The Turing Way](https://the-turing-way.netlify.app/index.html#) guides and Community Handbook. 
...
Our goal is to promote R - extended to other free and open source data science tools - and to do this in an open way by supporting and promoting open code sharing which includes other media content like videos of our workshops and conferences. 
...
The NHS-R Community is now hosted by the [Strategy Unit](https://www.strategyunitwm.nhs.uk/), part of NHS Midlands and Lancashire, which includes some administrative support, the hosting of an nhs.net email and two data scientists roles with NHS-R Community in their job descriptions. 
