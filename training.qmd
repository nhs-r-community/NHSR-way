...
Or using RStudio using the Packages tab in the bottom right tab which is explained in this [short video](https://www.youtube.com/watch?v=u1r5XTqrCTQ) from Andrew Jahn.
