...
- [**Introuction to Git and GitHub using R**](#intro-git)
...
With these courses, you need to have the relevant software and a place to store the files. Institutional rules and firewalls may, in some cases, prevent you from doing this on your work computer. For that reason, we often provide training using Posit Cloud - an onine space you can log into that already has most of the relevant tools. You are also welcome to complete the course on your work computer if you can, or on a personal computer. To help you explain to your work's IT departement about what tools you need on your machine and why, see our [Statement on Tools book](https://nhsrcommunity.com/books/posts/statement-on-tools/) for guidance.
